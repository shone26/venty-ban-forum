...
const navigation: NavigationItem[] = [
  { name: 'Dashboard', href: '/' },
  { name: 'Bans', href: '/bans' },
  { name: 'Appeals', href: '/appeals', requiresAuth: true, requiredRoles: [UserRole.ADMIN, UserRole.MODERATOR] },
];
...
const Header: React.FC = () => {
  ...
  const filteredNavigation = navigation.filter(item => {
    ...
    if (item.requiredRoles && !hasPermission(item.requiredRoles)) return false;
    return true;
  });
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <Link to="/" className="flex items-center">
                    <span className="text-white text-xl font-bold">GTA RP Ban Forum</span>
                  </Link>
                </div>
